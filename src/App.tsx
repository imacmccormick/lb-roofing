...
const services = [
  { icon: Home, title: "Asphalt Shingles", desc: "Affordable, versatile, and dependable protection in many styles." },
  { icon: Shield, title: "EPDM Rubber", desc: "Durable, weather-resistant membrane for flat roofs." },
  { icon: Sun, title: "TPO", desc: "Energy-efficient white membrane that reflects heat and reduces cooling costs." },
  { icon: Wrench, title: "Metal Roofing", desc: "Long-lasting and highly durable for harsh weather conditions." },
  { icon: Droplets, title: "Silicone Roof Coating", desc: "Liquid-applied seal to stop leaks and extend roof life without full replacement." },
  { icon: Grid, title: "Seamless Gutters", desc: "Custom-fit to reduce leaks and protect against water damage." },
  { icon: Home, title: "Siding", desc: "Enhance curb appeal and protection with quality vinyl or designer siding." },
  { icon: Sun, title: "Windows", desc: "Improve energy efficiency and insulation with modern window styles." }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex-shrink-0 flex items-center cursor-pointer" onClick={() => window.scrollTo(0,0)}>
              <img src="/assets/logo/Logo - Long - Color.svg" alt="LB Roofing Logo" className="h-10 sm:h-12 w-auto" />
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-3/5 space-y-8">
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <span className="font-semibold">Top Rated Local Experts</span>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, idx) => {
              ...
              return (
                <div key={idx} className="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition-shadow border border-gray-100 group">
      ...
      <footer className="bg-navy-blue text-white py-16 border-t-[8px] border-electric-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <img src="/assets/logo/Logo - Long - Dark Mode.svg" alt="LB Roofing Logo" className="h-12 w-auto" />
            </div>
